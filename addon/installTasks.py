# ObjPad/installTasks.py
# Copyright 2022-2026 Joseph Lee, released under GPL.
...
def onInstall():
	...
	# ObjPad requires Windows 10 21H2 or later.
	...
	if currentWinVer < minimumWinVer:
		...
		raise RuntimeError("Attempting to install ObjPad on Windows releases earlier than 10")

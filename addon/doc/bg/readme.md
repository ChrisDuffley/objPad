...
* За да се отрази промяната на разработчика, манифестният файл е актуализиран с новата информация.
...
* Добавени преводи.
* Клавишът Enter (както обикновения, така и този от цифровия блок) може да се използват за задействане на обекти.
